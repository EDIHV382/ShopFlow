<template>
  <div
    class="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-dark-950 via-dark-900 to-accent-950"
  >
    <div class="w-full max-w-md">
      ...
      <div class="card p-8 space-y-5 animate-scale-in">
        ...
        <div>
          ...
          <div class="relative">
            ...
            <button
              ...
              class="absolute right-3 top-1/2 -translate-y-1/2 text-dark-400"
            >
              {{ showPass ? '🙈' : '👁️' }}
            </button>
          </div>
        ...
        <p class="text-center text-sm text-dark-400">
          ¿Ya tienes cuenta?
          <NuxtLink to="/auth/login" class="text-primary-400 hover:text-primary-300 font-semibold"
