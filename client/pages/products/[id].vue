  ...
  <div class="container-page py-10">
    ...
    <div v-else-if="product" class="grid md:grid-cols-2 gap-12">
        ...
        <div v-if="product.images.length > 1" class="grid grid-cols-4 gap-3">
          <button
            ...
            :class="[
              ...
              mainImage === img ? 'border-primary-500' : 'border-dark-800 hover:border-dark-600',
            ]"
          >
            <NuxtImg
              :src="img"
      ...
      <div class="space-y-6">
        ...
        <div v-if="product.stock > 0" class="flex items-center gap-4">
          <div class="flex items-center gap-3 card px-4 py-2">
            <button
              ...
              class="text-dark-400 hover:text-white font-bold text-lg transition-colors"
            >
              −
            </button>
        ...
        <!-- Go to cart -->
        <NuxtLink
          v-if="cartStore.getItemQuantity(product.id) > 0"
          to="/cart"
