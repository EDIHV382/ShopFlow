<template>
  <div>
    ...
    <section class="relative overflow-hidden py-24 md:py-36">
      <div
        class="absolute inset-0 bg-gradient-to-br from-primary-900/40 via-dark-950 to-accent-900/30"
      />
      ...
      <div class="container-page relative z-10 text-center">
        <div
          class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-6 text-sm text-dark-300"
        >
        ...
        <p class="text-lg md:text-xl text-dark-400 max-w-2xl mx-auto mb-10 leading-relaxed">
          Descubre productos de calidad en electrónica, moda, hogar, deportes y más. Entrega rápida
          y pagos ultra seguros con Stripe.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <NuxtLink to="/products" class="btn btn-primary btn-lg"> 🛍️ Explorar catálogo </NuxtLink>
      ...
      <div class="container-page">
        ...
        <div v-else class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
          ...
          >
            ...
            <div
              class="text-sm font-semibold text-dark-200 group-hover:text-primary-400 transition-colors"
            >
              {{ cat.name }}
            </div>
    ...
    <!-- CTA Section -->
    <section
      class="py-16 bg-gradient-to-r from-primary-900/30 to-accent-900/30 border-y border-dark-800"
    >
      <div class="container-page text-center">
        <h2 class="text-3xl font-bold text-white mb-4">¿Listo para comprar?</h2>
        <p class="text-dark-400 mb-8">
          Regístrate ahora y empieza a disfrutar los mejores productos.
        </p>
...
useSeoMeta({
  ...
  description:
    'Descubre más de 50 productos en electrónica, moda, hogar, deportes y más. Pagos seguros con Stripe.',
...
onMounted(async () => {
  await Promise.all([
    ...
    api
      .get<PaginatedResponse<Product>>('/products', { limit: 8, sortBy: 'newest' })
      .then((data) => {
