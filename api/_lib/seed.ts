...
const products = [
  ...
  },
  {
    ...
    description: 'Intel Core i5 12th Gen, 16GB RAM, SSD 512GB, pantalla 15.6" FHD. Perfecta para trabajo y estudios.',
    price: 699.99,
    stock: 20,
    category: 'electronica',
  ...
  },
  {
    ...
    description: 'UHD 4K, webOS, HDR, compatible con Alexa y Google Assistant. Experiencia cinematográfica en casa.',
    price: 549.99,
    stock: 15,
    category: 'electronica',
  ...
  },
  {
    ...
    description: 'Chip M1, pantalla Liquid Retina 10.9", 256GB, compatible con Apple Pencil. Creatividad sin límites.',
    price: 749.99,
    stock: 25,
    category: 'electronica',
  ...
  },
  {
    ...
    description: 'Mirrorless 24.2MP, video 4K, AF inteligente con detección de sujetos. Para fotógrafos apasionados.',
    price: 899.99,
    stock: 10,
    category: 'electronica',
  ...
  },
  {
    ...
    description: "El jean icónico de Levi's. Corte recto clásico, denim 100% algodón, durabilidad legendaria.",
    price: 59.99,
    stock: 80,
    category: 'ropa-moda',
  ...
  },
  {
    ...
    description: 'Cuero genuino, forro interior, múltiples bolsillos. Un clásico atemporal que nunca pasa de moda.',
    price: 149.99,
    stock: 20,
    category: 'ropa-moda',
  ...
  },
  {
    ...
    description: 'Microfibra 1800 hilos, suaves y frescas, resistentes a manchas. King, Queen o Full disponibles.',
    price: 34.99,
    stock: 50,
    category: 'hogar-jardin',
  ...
  },
  {
    ...
    description: 'Luz regulable 3000K-6500K, mando a distancia, diseño nórdico minimalista. Ilumina con estilo.',
    price: 79.99,
    stock: 22,
    category: 'hogar-jardin',
  ...
  },
  {
    ...
    description: 'Acero inoxidable alemán, mangos ergonómicos, funda de bambú. Para chefs profesionales y amateurs.',
    price: 64.99,
    stock: 35,
    category: 'hogar-jardin',
  ...
  },
  {
    ...
    description: 'Material TPE ecológico, antideslizante, con líneas de alineación, incluye bolsa de transporte.',
    price: 29.99,
    stock: 70,
    category: 'deportes',
  ...
  },
  {
    ...
    description: 'Resistencia magnética de 8 niveles, pantalla LCD, sillín ajustable, silenciosa. Cardio desde casa.',
    price: 399.99,
    stock: 8,
    category: 'deportes',
  ...
  },
  {
    ...
    description: 'Cable de acero revestido, rodamientos de bola, mangos ergonómicos de aluminio. Para HIIT y boxeo.',
    price: 19.99,
    stock: 0,
    category: 'deportes',
  ...
  },
  {
    ...
    description: 'Una breve historia de la humanidad. Desde los primeros humanos hasta la era digital. Revolucionario.',
    price: 18.99,
    stock: 45,
    category: 'libros',
  ...
  // Juguetes (cat 6)
  {
    ...
    description: '7541 piezas, set coleccionable para adultos y jóvenes. El barco de naves más icónico del universo.',
    price: 849.99,
    stock: 5,
    category: 'juguetes',
  ...
  },
  {
    ...
    description: 'Grabación 4K/60fps, estabilización de 3 ejes, 38 min de vuelo, peso <249g sin registro necesario.',
    price: 499.99,
    stock: 12,
    category: 'juguetes',
  ...
  // Belleza (cat 7)
  {
    ...
    description: 'Concentración 20% vitamina C, ácido hialurónico, vitamina E. Ilumina y unifica el tono de tu piel.',
    price: 32.99,
    stock: 55,
  ...
  },
  {
    ...
    description: 'La fragancia icónica de Chanel. Floral aldehídico atemporal con notas de ylang-ylang y jazmín.',
    price: 189.99,
    stock: 20,
    category: 'belleza-salud',
  ...
  // Automóvil (cat 8)
  {
    ...
    description: '12V, 7000Pa de succión, 4.8m de cable, múltiples accesorios. Limpieza profunda en movimiento.',
    price: 39.99,
    stock: 40,
    category: 'automovil',
    images: ['https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600'],
  },
  {
    ...
    description: 'Grabación 4K frontal + 1080p trasera, visión nocturna, GPS integrado, modo parking automático.',
    price: 149.99,
    stock: 25,
    category: 'automovil',
  ...
  },
  {
    ...
    description: 'Montaje para ventilación o parabrisas, compatible con todos los smartphones, agarre ultra fuerte.',
    price: 18.99,
    stock: 85,
    category: 'automovil',
  ...
  },
  {
    ...
    description: 'Torre de 3 niveles, sisal natural, plataformas y tobogán. Tu gato tendrá su propio rascacielos.',
    price: 79.99,
    stock: 20,
    category: 'mascotas',
  ...
  },
  {
    ...
    description: 'Primera prensada en frío, DOP Jaén, polifenoles naturales. El mejor AOVE para cocina mediterránea.',
    price: 19.99,
    stock: 55,
    category: 'alimentacion',
  ...
  },
  {
    ...
    description: 'Panel IPS 4K 60Hz, 99% sRGB, entrada HDMI/DisplayPort, altura ajustable. Productividad y diseño.',
    price: 449.99,
    stock: 12,
    category: 'electronica',
  ...
  },
  {
    ...
    description: 'IP67 resistente al agua, 20h batería, sonido 360°, powerbank integrado para cargar tu móvil.',
    price: 169.99,
    stock: 42,
    category: 'electronica',
...
async function seed() {
  ...
  try {
    ...
    await client.query(`INSERT INTO users (name, email, password_hash, roles) VALUES ($1, $2, $3, $4)`, [
      'Admin ShopFlow',
      'admin@shopflow.com',
      adminHash,
